...
public class ReadyCommandHandler : ITelegramCommandHandler
{
    private readonly ITelegramBotClient _botClient;
    private readonly HiraganaService _hiraganaService;
    private readonly IUserRepository _userRepository;

    public ReadyCommandHandler(ITelegramBotClient botClient, HiraganaService hiraganaService, IUserRepository userRepository)
    {
