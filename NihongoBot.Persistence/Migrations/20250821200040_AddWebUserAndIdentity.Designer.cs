...
namespace NihongoBot.Persistence.Migrations
{
    ...
    [Migration("20250821200040_AddWebUserAndIdentity")]
    partial class AddWebUserAndIdentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NihongoBot.Domain.Aggregates.Kana.Kana", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NihongoBot.Domain.Aggregates.WebUser.WebUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NihongoBot.Domain.ImageCache", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NihongoBot.Domain.User", b =>
                {
                    ...
                    b.Property<bool>("WordOfTheDayEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("NihongoBot.Persistence.Identity.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("NihongoBot.Persistence.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NihongoBot.Domain.Aggregates.Kana.Kana", b =>
                {
                    b.OwnsMany("NihongoBot.Domain.Aggregates.Kana.KanaVariant", "Variants", b1 =>
                        {
