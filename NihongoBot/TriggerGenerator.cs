...
namespace NihongoBot
{
	public static class TriggerGenerator
	{
		public static List<ITrigger> GetNextTriggers(int intialMinHour, int maxHour)
		{
			...
			DateTime firstTriggerTime = new(date.Year, date.Month, date.Day, firstHour, firstMinute, 0);
			DateTime secondTriggerTime = new(date.Year, date.Month, date.Day, secondHour, secondMinute, 0);
